...
import { Kanban, Users, Building2, UserSquare2, ListChecks, LifeBuoy, Clock } from 'lucide-react';
import { cn } from '@/lib/utils';

const TABS = [
  { label: 'Pipeline', href: '/pipeline', icon: Kanban, exact: true },
  { label: 'Fichier Leads', href: '/leads', icon: Users, exact: true },
...
export function CloturerSubNav() {
