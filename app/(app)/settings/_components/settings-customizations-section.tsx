    ...
    >
      ...
      <div className="border border-[#e5e5e0] rounded-xl p-5 bg-white">
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="text-xs font-bold text-[#26251e]">Couleur personnalisée</p>
          ...
          <div className="flex items-center gap-2 shrink-0">
            <div
              className="w-8 h-8 rounded-lg border border-[#e5e5e0] cursor-pointer"
            ...
            <input
              ...
              className="sr-only"
            />
            <span className="text-xs font-mono text-[#26251e] border border-[#e5e5e0] rounded-lg px-3 py-1.5 bg-[#f4f4f3]">
      ...
      <div className="border border-[#e5e5e0] rounded-xl p-5 bg-white space-y-3">
        <div>
          <p className="text-xs font-bold text-[#26251e]">Image de fond</p>
          <p className="text-[11px] text-[#7a7a76] mt-0.5">
        ...
        {data.backgroundImageBase64 && (
          <div className="relative w-full h-24 rounded-lg overflow-hidden border border-[#e5e5e0]">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="flex items-center gap-2 px-4 py-2 border border-[#e5e5e0] rounded-lg text-xs font-semibold text-[#26251e] hover:bg-[#f4f4f3] transition-colors">
      ...
      <div className="border border-[#e5e5e0] rounded-xl p-5 bg-white">
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="text-xs font-bold text-[#26251e]">Afficher le logo de l'espace de travail</p>
            <p className="text-[11px] text-[#7a7a76] mt-0.5">
          ...
          <button
            ...
            className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 focus:outline-none ${
              data.showWorkspaceLogo ? 'bg-[#059669]' : 'bg-[#f4f4f3]-foreground/30'
            }`}
          >
            <span
      ...
      {/* Chat section */}
      <div>
        <h3 className="text-[10px] font-bold uppercase tracking-wider text-[#7a7a76] mb-3">Chat</h3>
        <div className="space-y-3">
          {/* Hide model logo */}
          <div className="border border-[#e5e5e0] rounded-xl p-5 bg-white">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-xs font-bold text-[#26251e]">Masquer le logo du modèle</p>
                <p className="text-[11px] text-[#7a7a76] mt-0.5">
              ...
              <button
                ...
                className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 focus:outline-none ${
                  data.hideModelLogo ? 'bg-[#059669]' : 'bg-[#f4f4f3]-foreground/30'
                }`}
              >
                <span
                  className={`pointer-events-none inline-block h-4 w-4 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${
          ...
          <div className="border border-[#e5e5e0] rounded-xl p-5 bg-white space-y-3">
            <div>
              <p className="text-xs font-bold text-[#26251e]">Avertissement légal du chat</p>
              <p className="text-[11px] text-[#7a7a76] mt-0.5">
            ...
            <textarea
              ...
              rows={3}
              className="w-full text-xs px-3.5 py-2.5 border border-[#e5e5e0] rounded-lg focus:outline-none focus:ring-1 focus:ring-primary bg-[#fafaf8] resize-none text-[#26251e] placeholder:text-[#7a7a76]"
            />
          </div>
          ...
          <div className="border border-[#e5e5e0] rounded-xl p-5 bg-white space-y-3">
            <div>
              <p className="text-xs font-bold text-[#26251e]">Encadrés personnalisés</p>
              <p className="text-[11px] text-[#7a7a76] mt-0.5">
            ...
            {data.infoBoxes.map((box, idx) => (
              <div key={idx} className="flex items-center gap-2">
                <div className="flex-1 text-xs px-3.5 py-2.5 border border-[#e5e5e0] rounded-lg bg-[#f4f4f3] text-[#26251e] truncate">
                  {box}
                </div>
                <button
                  onClick={() => removeInfoBox(idx)}
                  className="p-2 text-[#7a7a76] hover:text-destructive transition-colors"
                >
                  <Trash2 className="w-3.5 h-3.5" />
                </button>
              </div>
            ...
            {data.infoBoxes.length < 3 && (
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="flex-1 text-xs px-3.5 py-2.5 border border-[#e5e5e0] rounded-lg focus:outline-none focus:ring-1 focus:ring-primary bg-[#fafaf8] text-[#26251e] placeholder:text-[#7a7a76]"
                />
                <button
                  onClick={addInfoBox}
                  disabled={!newBox.trim()}
                  className="p-2 text-[#059669] hover:bg-[#059669]/10 rounded-lg transition-colors disabled:opacity-40"
                >
