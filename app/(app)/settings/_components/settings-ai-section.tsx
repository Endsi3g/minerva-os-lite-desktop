...
// Inline custom Switch component for warning-free dependency-free operation
          ...
          <div className="space-y-4 pt-1">
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <LocalSwitch 
                ...
                onCheckedChange={(checked) => onChange({ autoInsights: checked })}
                ariaLabel="Basculer la generation automatique d'analyses hebdomadaires"
              />
            </div>
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <LocalSwitch 
                ...
                onCheckedChange={(checked) => onChange({ autoFollowUps: checked })}
                ariaLabel="Basculer la suggestion de relances dans le panneau Today"
              />
            </div>
          </div>
        </CardContent>
