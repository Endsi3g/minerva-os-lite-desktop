...
const roadmapData: RoadmapItem[] = [
  ...
  { module: 'v4 · Acquisition', feature: 'Scoring v2 — ICP + urgence + revenu + fraîcheur', desc: 'Score multidimensionnel : fit ICP, probabilité de réponse, urgence, potentiel revenu, fraîcheur de la donnée, source quality score. Remplace le scoring v1 par un modèle actionnable.', priority: 'high', status: 'available' },
  { module: 'v4 · Acquisition', feature: 'Déduplication & fusion multi-source', desc: 'Détection automatique des doublons par domaine + téléphone + nom business. Règles de fusion intelligentes. Source primaire + source assistée. Normalisation email / téléphone / domaine.', priority: 'high', status: 'available' },
  { module: 'v4 · Acquisition', feature: 'Enrichissement automatique avancé', desc: 'Logo, taille entreprise, catégories, stack tech estimée, présence web, avis, historique compte. Enrichissement firme/compte en plus de l\'individu.', priority: 'medium', status: 'available' },
  ...
  { module: 'v4 · Outreach', feature: 'Composer unifié par lead', desc: 'Écran unique par lead pour voir et envoyer : email, appel, note vocale, task, RDV. Zéro friction pour l\'outreach quotidien.', priority: 'high', status: 'available' },
  ...
  { module: 'v4 · Ads', feature: 'Facebook Lead Ads — ingestion en temps réel', desc: 'Connexion compte Meta Ads, sélection page + formulaire, ingestion temps réel des leads, mapping des champs, création auto de lead avec source / campaign / adset / ad IDs.', priority: 'high', status: 'available' },
  { module: 'v4 · Ads', feature: 'Google Ads — import conversions & formulaires', desc: 'Import des conversions, campagnes, groupes d\'annonces, mots-clés. Si lead forms : ingestion directe. Si formulaires site : attribution UTM/GCLID vers le lead. Pages /ads, /ads/leads, /ads/attribution, /ads/campaigns/[id].', priority: 'high', status: 'available' },
  { module: 'v4 · Ads', feature: 'Attribution marketing complète', desc: 'Source, medium, campaign, adset, ad, keyword, landing page, first touch / last touch. KPIs : CPL, coût par réponse, coût par RDV, coût par deal, ROAS pipeline, ROAS deals won, délai lead → contact, délai lead → RDV.', priority: 'high', status: 'available' },
  { module: 'v4 · Ads', feature: 'Inbound Speed-to-Lead (SLA < 5 min)', desc: 'Pour les leads Facebook / Google : auto-assignation instantanée, notification push/Slack, email ou SMS auto, booking link immédiat, timer « first contact SLA ». Opérateur Hermes dédié.', priority: 'high', status: 'available' },
  ...
  { module: 'Bibliothèque', feature: 'Images via Supabase Storage', desc: 'Onglet Images dans la bibliothèque : upload vers bucket library-assets, galerie responsive, copie URL en 1 clic, suppression. Stockage public Supabase.', priority: 'medium', status: 'available' },
  { module: 'Agence', feature: 'Setup agence complet (workspace + couleurs + logo)', desc: 'Analyse site web agence : mise à jour workspace.name + workspace.logo_base64 (sidebar), services importés avec prix numériques, logo sauvegardé en bibliothèque. Modal de sélection couleur d\'accent avec aperçu live. Migration v4.7.', priority: 'high', status: 'available' },
