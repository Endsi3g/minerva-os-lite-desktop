  ...
  const getVariantStyles = () => {
    ...
    switch (variant) {
      ...
      case "warning":
        return {
          container: hasGradient
            ? "sticky top-0 z-50 w-full border-b border-yellow-500/20 backdrop-blur supports-[backdrop-filter]:bg-yellow-50/60"
            : "sticky top-0 z-50 w-full border-b bg-yellow-50 border-yellow-200 shadow-sm backdrop-blur",
          wrapper:
            "relative container mx-auto flex flex-col sm:flex-row md:items-start items-center justify-between px-3 sm:px-4 py-2 sm:py-3 gap-2 sm:gap-4",
          content:
            "flex flex-col sm:flex-row md:items-start items-center gap-2 w-full",
          title: hasGradient
            ? "text-sm font-medium text-yellow-800 leading-tight"
            : "text-sm font-medium text-yellow-800 leading-tight",
          description: hasGradient
      ...
      case "success":
        return {
          container: hasGradient
            ? "sticky top-0 z-50 w-full border-b border-green-500/20 backdrop-blur supports-[backdrop-filter]:bg-green-50/60"
            : "sticky top-0 z-50 w-full border-b bg-green-50 border-green-200 shadow-sm backdrop-blur",
          wrapper:
            "relative container mx-auto flex flex-col sm:flex-row md:items-start items-center justify-between px-3 sm:px-4 py-2 sm:py-3 gap-2 sm:gap-4",
          content:
            "flex flex-col sm:flex-row md:items-start items-center gap-2 w-full",
          title: hasGradient
            ? "text-sm font-medium text-green-800 leading-tight"
            : "text-sm font-medium text-green-800 leading-tight",
          description: hasGradient
      ...
      case "info":
        return {
          container: hasGradient
            ? "sticky top-0 z-50 w-full border-b border-blue-500/20 backdrop-blur supports-[backdrop-filter]:bg-blue-50/60"
            : "sticky top-0 z-50 w-full border-b bg-blue-50 border-blue-200 shadow-sm backdrop-blur",
          wrapper:
            "relative container mx-auto flex flex-col sm:flex-row md:items-start items-center justify-between px-3 sm:px-4 py-2 sm:py-3 gap-2 sm:gap-4",
          content:
            "flex flex-col sm:flex-row md:items-start items-center gap-2 w-full",
          title: hasGradient
            ? "text-sm font-medium text-blue-800 leading-tight"
            : "text-sm font-medium text-blue-800 leading-tight",
          description: hasGradient
      ...
      case "announcement":
        return {
          container: hasGradient
            ? "sticky top-0 z-50 w-full border-b border-purple-500/20 backdrop-blur supports-[backdrop-filter]:bg-purple-50/60"
            : "sticky top-0 z-50 w-full border-b bg-purple-50 border-purple-200 shadow-sm backdrop-blur",
          wrapper:
            "relative container mx-auto flex flex-col sm:flex-row md:items-start items-center justify-between px-3 sm:px-4 py-2 sm:py-3 gap-2 sm:gap-4",
          content:
            "flex flex-col sm:flex-row md:items-start items-center gap-2 w-full",
          title: hasGradient
            ? "text-sm font-medium text-purple-800 leading-tight"
            : "text-sm font-medium text-purple-800 leading-tight",
          description: hasGradient
