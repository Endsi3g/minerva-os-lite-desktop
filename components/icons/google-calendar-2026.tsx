...
export function GoogleCalendar2026Icon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="192" height="192" viewBox="0 0 192 192" fill="none" {...props}>
      ...
      <g mask="url(#gcal-mask-a)">
        <path fill="url(#gcal-grad-b)" d="M0 0h166v76H0z" transform="matrix(1 0 0 -1 13 172)"/>
      </g>
      <mask id="gcal-mask-c" width="154" height="152" x="19" y="20" maskUnits="userSpaceOnUse" style={{ maskType: 'alpha' }}>
      ...
      <g mask="url(#gcal-mask-c)">
        <path fill="url(#gcal-grad-d)" d="M32 27.2C32 16.596 40.596 8 51.2 8h89.6c10.604 0 19.2 8.596 19.2 19.2V96H32z" filter="url(#gcal-filt-e)"/>
      </g>
      ...
      <defs>
        <linearGradient id="gcal-grad-b" x1="83" x2="83" y1="76" gradientUnits="userSpaceOnUse">
          <stop stopColor="#4fa0ff"/>
          <stop offset="1" stopColor="#3186ff"/>
        </linearGradient>
        <linearGradient id="gcal-grad-d" x1="89.06" x2="89.06" y1="21.75" y2="96.39" gradientUnits="userSpaceOnUse">
          <stop stopColor="#a9a8ff"/>
          <stop offset=".8" stopColor="#3c90ff"/>
        </linearGradient>
        <filter id="gcal-filt-e" width="152" height="112" x="20" y="-4" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
...
export default GoogleCalendar2026Icon;